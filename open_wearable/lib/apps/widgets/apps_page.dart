...
import 'package:open_wearable/apps/eargpt/widgets/eargpt_page.dart';
...
List<AppInfo> _apps = [
  ...
  AppInfo(
    logoPath: "lib/apps/eargpt/assets/logo.png",
    title: "Ear GPT",
    description: "Have a conversation about your health data",
    widget: EargptPage(),
  ),
];
